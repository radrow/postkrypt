...
testCompTrans v1 v2 p =
  trpoint (translate (vec v1) >< translate (vec v2)) (point p) ===
  trpoint (translate (vec v1 >< vec v2)) (point p)

testCompRot :: R -> R -> R2 -> Property
testCompRot r1 r2 p =
  trpoint (rotate r1 >< rotate r2) (point p) ===
...
testFullCircleRot2 r p =
  trpoint (rotate (r + fullCircle)) (point p) === trpoint (rotate r) (point p)
